Public Class LaporanPendapatanAdministrasi
    ...
    Sub showData()
        sql = "select idanggota, anggota, idpinjam, tglpinjam, administrasi from qpinjam where (idanggota ilike '%" & txt_search.Text & "%' or anggota ilike '%" & txt_search.Text & "%') and tglpinjam between '" & dtp_mulai.Value.ToString("yyyy-MM-dd") & "' and '" & dtp_sampai.Value.ToString("yyyy-MM-dd") & "'"
    ...
    Private Sub btn_cetak_Click(sender As Object, e As EventArgs) Handles btn_cetak.Click
        ...
        PreviewLaporanPendapatanAdministrasi.mulai = dtp_mulai.Value.ToString("yyyy-MM-dd")
        PreviewLaporanPendapatanAdministrasi.sampai = dtp_sampai.Value.ToString("yyyy-MM-dd")
