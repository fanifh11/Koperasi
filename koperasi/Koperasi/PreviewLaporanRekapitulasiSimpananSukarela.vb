Public Class PreviewLaporanRekapitulasiSimpananSukarela

    Public sql As String
    Public mulai As String
    Public sampai As String

    Private Sub PreviewLaporanRekapitulasiSimpananSukarela_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sqlidentitas As String = "select * from tblidentitas where idkoperasi = 1"

        ReportViewer1.Reset()
ReportViewer1.SetDisplayMode(Microsoft.Reporting.WinForms.DisplayMode.PrintLayout)
Me.WindowState = FormWindowState.Maximized
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Koperasi.LaporanRekapitulasiSimpananSukarela.rdlc"
