Public Class LaporanRekapitulasiSaldoPiutang
    ...
    Sub showData()
        sql = "select idanggota, anggota, idpinjam, besarpinjam, saldopinjam, (besarpinjam - saldopinjam) as bayarpokok from qpinjam where tglpinjam < '" & dtp_TglRekap.Value.ToString("dd-MM-yyyy") & " 23:59'"
        ...
        lbl_Detail.Text = "Pinjam : " & numberFor(toDouble(getValue("select sum(besarpinjam) as besarpinjam from qpinjam where tglpinjam < '" & dtp_TglRekap.Value.ToString("dd-MM-yyyy") & " 23:59'", "besarpinjam"))) & " Bayar : " & numberFor(toDouble(getValue("select sum(besarpinjam - saldopinjam) as bayar from qpinjam where tglpinjam < '" & dtp_TglRekap.Value.ToString("dd-MM-yyyy") & " 23:59'", "bayar"))) & " Sisa : " & numberFor(toDouble(getValue("select sum(saldopinjam) as saldopinjam from qpinjam where tglpinjam < '" & dtp_TglRekap.Value.ToString("dd-MM-yyyy") & " 23:59'", "saldopinjam")))
    End Sub
