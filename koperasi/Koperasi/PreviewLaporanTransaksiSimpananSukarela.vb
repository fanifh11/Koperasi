Public Class PreviewLaporanTransaksiSimpananSukarela

    Public sql As String
    Public mulai As String
    Public sampai As String

    Private Sub PreviewLaporanTransaksiSimpananSukarela_Load(sender As Object, e As EventArgs) Handles MyBase.Load
