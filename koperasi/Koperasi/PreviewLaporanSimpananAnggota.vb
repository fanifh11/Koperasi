Public Class PreviewLaporanSimpananAnggota

    Public sql As String
    Public mulai As String
    Public sampai As String

    Private Sub PreviewLaporanSimpananAnggota_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sqlidentitas As String = "select * from tblidentitas where idkoperasi = 1"

        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Koperasi.LaporanPembayaranSimpananPokok.rdlc"
