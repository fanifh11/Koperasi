Public Class FormKoreksiPinjamorPiutangNasabah
    ...
    Sub hitungAngsuranPokok()
        Dim besarPinjam As Double = toDouble(txt_BesarPinjam.Text)
    ...
    Sub hitungBunga()
        ...
        txt_AngsuranBunga.Text = Math.Ceiling((besarPinjam * persenBunga) / 100).ToString
    ...
    Sub hitungJumlahAngsuran()
        Dim jumAngsuranPokok As Double = toDouble(txt_AngsuranPokok.Text)
        Dim jumAngsuranBunga As Double = toDouble(txt_AngsuranBunga.Text)

        txt_JumAngsuran.Text = Math.Ceiling(jumAngsuranBunga + jumAngsuranPokok).ToString
    ...
    Sub jumlahUangDiterima()
        ...
        txt_UangDiterima.Text = (besarPinjam - (biayaAdministrasi + biayaAsuransi)).ToString
    ...
    Private Sub dgv_DataPeminjaman_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_DataPeminjaman.CellClick
        If e.RowIndex >= 0 Then
            ...
            Me.txt_BesarPinjam.Text = dgv_DataPeminjaman.Rows(e.RowIndex).Cells(6).Value
            ...
            Me.txt_Asuransi.Text = dgv_DataPeminjaman.Rows(e.RowIndex).Cells(9).Value
            Me.txt_Administrasi.Text = dgv_DataPeminjaman.Rows(e.RowIndex).Cells(10).Value
            Me.txt_UangDiterima.Text = dgv_DataPeminjaman.Rows(e.RowIndex).Cells(11).Value
            Me.txt_AngsuranPokok.Text = dgv_DataPeminjaman.Rows(e.RowIndex).Cells(12).Value
            Me.txt_AngsuranBunga.Text = dgv_DataPeminjaman.Rows(e.RowIndex).Cells(13).Value
            Me.txt_JumAngsuran.Text = dgv_DataPeminjaman.Rows(e.RowIndex).Cells(14).Value
    ...
    Private Sub btn_Simpan_Click(sender As Object, e As EventArgs) Handles btn_Simpan.Click
        ...
        Else
            ...
            Dim besarPinjam As String = txt_BesarPinjam.Text
            ...
            Dim diterima As String = txt_UangDiterima.Text

            Dim angsuranPokok As String = txt_AngsuranPokok.Text
            Dim angsuranBunga As String = txt_AngsuranBunga.Text
            Dim jumAngsuran As String = txt_JumAngsuran.Text
