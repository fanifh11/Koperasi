Public Class PreviewSuratPerjanjianBPKB
    ...
    Private Sub PreviewBuktiPembayaran_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Koperasi.SuratPerjanjianBPKB.rdlc"
        ...
        ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("jaminanBPKB", CType(getData("select * from tbljaminankendaraan where idpinjam = '" & idpinjam & "'"), DataTable)))
        ReportViewer1.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter("nasabah", getValue(sql, "anggota").ToString))
