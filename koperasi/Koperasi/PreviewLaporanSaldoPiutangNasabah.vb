Public Class PreviewLaporanSaldoPiutangNasabah

    Public sql As String
    Public sampai As String

    Private Sub PreviewLaporanSaldoPiutangNasabah_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sqlidentitas As String = "select * from tblidentitas where idkoperasi = 1"

        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Koperasi.LaporanSaldoPiutangNasabah.rdlc"
