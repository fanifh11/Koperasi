Public Class LaporanRekapitulasiPendapatanBunga
    ...
    Private Sub btn_cetak_Click(sender As Object, e As EventArgs) Handles btn_cetak.Click
        ...
        PreviewLaporanRekapitulasiPendapatanBunga.mulai = dtp_mulai.Value.ToString("dd-MM-yyyy")
        PreviewLaporanRekapitulasiPendapatanBunga.sampai = dtp_sampai.Value.ToString("dd-MM-yyyy")
