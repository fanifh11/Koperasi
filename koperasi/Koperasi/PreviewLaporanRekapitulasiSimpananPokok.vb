Public Class PreviewLaporanRekapitulasiSimpananPokok
    ...
    Private Sub PreviewLaporanRekapitulasiSimpananPokok_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sqlidentitas As String = "select * from tblidentitas where idkoperasi = 1"

        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Koperasi.LaporanRekapitulasiSimpananPokok.rdlc"
